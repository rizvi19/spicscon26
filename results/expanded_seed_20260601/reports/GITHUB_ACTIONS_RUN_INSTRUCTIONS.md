...
5. In the branch selector, choose `codex/research-evidence-upgrades`.
...
The workflow uploads an artifact even if execution fails. It also commits generated outputs, logs, and reports back to the selected branch when they change.
